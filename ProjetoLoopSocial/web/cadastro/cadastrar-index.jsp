...
<html lang="pt-br">
    ...
    <!--    Verificação da sessão se o usuario está logado, caso sim ele não consegue acessar a página de cadastro!-->
    <%
    ...
    <head>
        ...
        <!--Titulo-->
        <title>Cadastrar - Loop Social</title>
        <!-- Favicon-->
                ...
                <div class="d-block justify-content-center ">
                    <div class="user_card">
                        ...
                        <div class="d-flex justify-content-center form_container">
                            ...
                            <!--forms para se cadastrar-->
                            <form method="post" action="cadastrar.jsp" style="width: 398px">

                                <div class="input-group mb-3">
                                    <div class="input-group-append">
                                        <span class="input-group-text"><i class="fas fa-user"></i></span>
                                    </div>
                                    <input type="text" id="nome" name="nome" class="form-control input_user" placeholder="nome" required>
                                </div>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" id="sobrenome" name="sobrenome" class="form-control input_user" placeholder="sobrenome" required>
                                </div>
                                ...
                                <div class="input-group mb-3">                                    
                                    <textarea id="resumo" name="resumo" class="form-control input_pass" placeholder="Descreva suas melhores habilidades" rows="2" cols="40 " required ></textarea>
                                </div>

                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" name="aceiteTermo" class="custom-control-input" id="aceiteTermo" required>
                                        <label class="custom-control-label" for="aceiteTermo">Aceito os termos de uso</label>
                                    </div>
                                </div>
                        ...
                        <div class="mt-2 mb-3">
                            <div class="d-flex justify-content-center links">
                                Já possui uma conta? <a href="../login/login-index.jsp" class="ml-2">Fazer login</a>
                            </div>
