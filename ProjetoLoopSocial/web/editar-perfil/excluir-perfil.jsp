...
<html lang="pt-br">
    <head>
        ...
        <!--Titulo-->
        <title>Excluir Cadastro - Loop Social</title>
        <!-- Favicon-->
                ...
                <div class="d-block justify-content-center ">
                    <div class="user_card">
                        ...
                        <div class="d-flex justify-content-center form_container style="width: 100%; height: 50px;"">
                            ...
                            <form method="post" action="excluir.jsp" style="width: 398px">

                                <div class="input-group mb-3" >
                                    <div class="input-group-append" >
                                        <span class="input-group-text" style="width: 40px"><i class="fas fa-envelope"></i></span>
                                    </div>
                                    <input type="email" id="email" name="email" class="form-control input_user" placeholder="email" value="<%=usuarioLogado.getEmail()%>" disabled>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label class="custom-control-label" for="aceiteTermo">Estou ciente que essa ação é irreversível, mas ainda quero continuar</label>
                                    </div>
                                </div>
                                
                                <div class="d-flex justify-content-center mt-3 login_container">
                                    <button type="submit" name="button" class="btn login_btn btn-primary">Excluir Cadastro</button>
                                </div>
                            </form>
                        </div>
